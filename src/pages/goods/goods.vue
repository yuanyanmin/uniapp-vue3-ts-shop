...
import type { SkuPopupLocaldata, SkuPopupInstanceType, SkuPopupEvent } from '@/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup.ts'
...
const onSwiperChange: UniHelper.SwiperOnChange = (ev) => {
  activeIndex.value = ev.detail.current + 1
}
      ...
      <view class="preview">
        <swiper @change="onSwiperChange" circular>
          <swiper-item v-for="item in goods?.mainPictures" :key="item">
            <image mode="aspectFill" :src="item" @tap="onTagImage(item)" />
          </swiper-item>
        </swiper>
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          <!-- 属性详情 -->
          <view v-for="item in goods?.details.properties" :key="item.value" class="item">
